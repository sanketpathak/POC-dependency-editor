...
export class LicenseComponent implements OnInit, OnChanges {
  ...
  ngOnChanges() {
    console.log('lis data in license module = ', this.lisData);
    if (this.licenseData) {
      console.log('hola'); // || this.lisData
    ...
    // tslint:disable-next-line:one-line
      ...
      console.log('hello'); // this.licenseData ||
      if (this.lisData.status.toLowerCase() === 'successful') { // this.licenseData.status.toLowerCase() === 'successful' ||  
        ...
        console.log('hello'); // || this.licenseData.status.toLowerCase() === 'failure'
        this.hasIssue = 'na';
        this.stackLicense = 'Unknown';
        this.stackStatus = this.lisData.status;
  ...
  public filter(key: string) {
    ...
    console.log("license synonym ", key, licenseSynonym[key])
