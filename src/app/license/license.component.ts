...
// }
  // tslint:disable-next-line:one-line
      ...
      } else if (this.lisData.status.toLowerCase() === 'failure') { console.log('hello'); // || this.licenseData.status.toLowerCase() === 'failure'
        this.hasIssue = 'na';
        this.stackLicense = 'Unknown';
        this.stackStatus = this.lisData.status;
  ...
  public displayLicenses(liData): void {
    if (this.stackStatus === 'Successful') {debugger;
      this.charts['data'] = {
      columns: liData,
    //   columns: [
    //     // ['data1', 30],
...
public filter(key:string) {
  ...
  debugger;console.log("license synonym ",key,licenseSynonym[key])
